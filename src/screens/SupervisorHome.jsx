...
export default function SupervisorHome({ user, onIniciarJornada, onExit }) {
    ...
    if (seccion === "muro_comunicacion") {
        if (subSub === "ver")   return <VerComunicacionesScreen  onBack={() => setSubSub(null)} />;
        if (subSub === "crear") return <CrearComunicacionScreen  onBack={() => setSubSub(null)} />;
        const MURO_MENUS = [
    ...
    if (seccion === "muro_procedimientos") {
        if (subSub === "ver")   return <VerProcedimientosScreen  onBack={() => setSubSub(null)} />;
        if (subSub === "subir") return <SubirProcedimientoScreen onBack={() => setSubSub(null)} />;
        const PROC_MENUS = [
    ...
    if (seccion === "capacitacion") {
        if (subSub === "ver")   return <VerCapacitacionesScreen  onBack={() => setSubSub(null)} />;
        if (subSub === "subir") return <SubirCapacitacionScreen  onBack={() => setSubSub(null)} />;
        const CAP_MENUS = [
    ...
    if (seccion === "redactar_informe") {
        if (subSub === "sencillo")  return <InformeSencilloScreen onBack={() => setSubSub(null)} />;
        if (subSub === "gravedad")  return <InformeNovedadScreen  onBack={() => setSubSub(null)} />;
        const CREAR_MENUS = [
