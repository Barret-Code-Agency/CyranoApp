...
export const MODULOS_DEF = [
    {
        ...
        modulos: [
            ...
            { key: "gestion_premios",     label: "Premios y Tokens",          icon: "🎁", desc: "Catálogo de premios y aprobación de canjes del personal" },
        ],
    },
    {
    ...
    },
    {
        ...
        modulos: [
            ...
            { key: "condicion_insegura",   label: "Reporte Condición/Acto Inseguro", icon: "⚠️", desc: "Reportar condiciones o actos inseguros" },
        ],
    },
];
